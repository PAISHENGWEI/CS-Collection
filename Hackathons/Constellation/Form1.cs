...
namespace Constellation
{
    public partial class Form1 : Form
    {
        ...
        private static Dictionary<int, string> CreateVirgo()
        {
            ...
            result.Add(4, "你是Virgo處女座中最為 龜毛的，尤其容易劃地自限，要特別注意。");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string num = dateTimePicker1.Text;
            ...
            var result = dictionary.Where((x) => x.Key == add);
            foreach (var i in result)
            {
                label4.Text = "你的生命靈數是" + i.Key.ToString() + ":" + i.Value;
            }
